...
namespace Evbg.CC.Driver.SpotterGlobal.UDC.DeviceContracts
{
    /// <summary>
    ...
    public class UDC : UDCBase, IUDC, IDeserializationCallback, INotifyPropertyChanged
    {
        [NonSerialized]
        private ILog _log;
        ...
        {
            _log = LogManager.GetLogger(typeof(UDC));
