...
namespace Evbg.CC.Driver.SpotterGlobal.Radar.Zone
{
    /// <summary>
    ...
    public class Zone : ZoneBase, IZone, IDeserializationCallback, INotifyPropertyChanged
    {
        [NonSerialized]
        private ILog _log;
        ...
        {
            _log = LogManager.GetLogger(typeof(Zone));
