...
namespace Evbg.CC.Driver.SpotterGlobal.Radar
{
    ...
    public class Radar : RadarBase, IRadar, IDeserializationCallback, INotifyPropertyChanged
    {
        [NonSerialized]
        private ILog _log;
        ...
        public Action<object, object> TamperEvent { get; set; }
        ...
        /// </summary>
        /// <param name="e"></param>
        public void HandleAlarmTrackRecieved(GenericEventArgs e)
        {
        ...
        private void OnTamperEvent(TamperEventArgs tamperEventArgs)
        {
        ...
        {
            _log = LogManager.GetLogger(typeof(Radar));
        ...
        public override void GetDeviceDetails(string DeviceId)
        {
            throw new NotImplementedException();
        }
    ...
    internal class TamperEventArgs
    {
        private Radar radar;
        private DateTime timestamp;

        public TamperEventArgs(Radar radar, DateTime timestamp)
        {
            this.radar = radar;
            this.timestamp = timestamp;
        }

        public TamperStatus TamperStatus { get; set; }
        public string StatusDescription { get; set; }
        public string Description { get; set; }
        public double? Latitude { get; set; }
        public double? Longitude { get; set; }
        public double? Altitude { get; set; }
        public int SpatialReferenceIdentifier { get; set; }
    }
}
